...
export function TrustBar({ dict }: { dict: Dict["trustBar"] }) {
  return (
    <div className="relative z-10 mx-auto max-w-[1360px] px-6 pb-16 md:px-10">
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <div className="text-[16px] font-bold text-slate-900">{dict.rating.value}</div>
          <div className="text-[13px] text-slate-500">{dict.rating.base}</div>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="text-[16px] font-bold text-slate-900">{dict.projects.value}</div>
          <div className="text-[13px] text-slate-500">{dict.projects.base}</div>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="text-[16px] font-bold text-slate-900">{dict.support.value}</div>
          <div className="text-[13px] text-slate-500">{dict.support.base}</div>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="text-[16px] font-bold text-slate-900">{dict.delivery.value}</div>
          <div className="text-[13px] text-slate-500">{dict.delivery.base}</div>
        </div>

        <div className="flex flex-col items-center text-center">
          <div className="mb-2 text-[13px] font-semibold text-slate-700">{dict.tech}</div>

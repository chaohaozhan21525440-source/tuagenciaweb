  ...
  servicesPage: {
    ...
    hero: {
      ...
      navItems: [
        ...
        { num: "03", id: "seo",    title: "Technical SEO & maintenance" },
      ],
    },
    hubCards: {
      eyebrow: "WHAT WE DO",
      ...
      items: [
        ...
        {
          id: "seo",
          eyebrow: "SEO & MAINTENANCE",
          title: "Technical SEO & maintenance",
          blurb: "Ranking, content and ongoing support so your website performs month after month.",
        },
      ],
    },
    detailNav: {
  ...
  servicesDetail: {
    ...
    seo: {
      ...
      hero: {
        ...
        h1Accent: "and maintenance that looks after your site every month.",
        sub:
      ...
      valueProp: {
        eyebrow: "WHY IT MATTERS",
        h2: "Ranking and maintenance go hand in hand.",
        body:
          "A site without technical SEO doesn't show up. A site without maintenance breaks. We do both at once: fix the technical foundations, produce the content that matters, and look after the site month after month with backups, monitoring and direct support. One invoice, one team.",
      },
      included: {
        eyebrow: "WHAT'S INCLUDED",
        h2: "Growth and support, end-to-end.",
        sub: "Measurable work with monthly reports and direct support when you need it.",
        items: [
          ...
          { title: "Schema.org and optimized content", desc: "Rich snippets + keyword research + writing focused on search intent." },
          { title: "Prepaid hour bank", desc: "Buy 5h, 10h or 20h and use them when you need them. No annual expiry." },
          { title: "Daily backups and 24/7 monitoring", desc: "Fast restore and downtime alerts before customers notice." },
          { title: "Direct WhatsApp support", desc: "Fast response during business hours for changes or urgent issues." },
        ],
      },
      process: {
        eyebrow: "HOW WE WORK",
      ...
      useCases: {
        eyebrow: "WHEN IT MAKES SENSE",
        h2: "This is for you if…",
        sub: "Combining SEO and maintenance works best when these scenarios apply.",
        items: [
          ...
          { title: "You want to grow without neglecting the site", desc: "Rank new content while keeping an eye on uptime, backups and technical changes." },
          { title: "You're left without a technical team", desc: "You launched with another provider and now no one looks after the site or positions it." },
          { title: "You want to avoid endless fees", desc: "Pay for real hours — not a fixed monthly invoice you pay even when there's no work." },
        ],
      },
      cta: {
        eyebrow: "LET'S START",
        h2: "Ready to grow and sleep easy?",
        sub: "We'll send a free initial audit and a closed proposal in less than 48 hours.",
        primary: "Request a quote",
        secondary: "WhatsApp",
      },
    },
